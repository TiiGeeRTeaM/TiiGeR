--Begin GroupManager.lua By @Arashwm
...
local function delmsg (Arashwm,Arashwm)
    msgs = MaTaDoR.msgs 
...
text = string.gsub(text, "no", "`🔓`")
 ...
 text =  string.gsub(text, "no", "#غـیرفعال")
 end
...
if not lang then
text = [[
̶Ƭ̶iiGeR̶ ̶M̶υ̶т̶є̶т̶ι̶м̶є̶ ̶Ƈ̶σ̶м̶м̶α̶η̶ɗ̶ѕ:
*⚡️тo ѕee тнe coммαɴdѕ oғ yoυr deѕιred ιтeм ѕυвмιт*
🌐 ҽɳɠʅιʂԋ cσɱɱαɳԃʂ :
*👉 Mute all*
⏺Mute groups
