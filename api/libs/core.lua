...
local lang = redis:get(hash) 
 ...
 text = '_Welcome To_ *Group Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = "> Lock Edit", callback_data='TiiGeRTeaM'}, 
...
local lang = redis:get(hash) 
   ...
   if not lang then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = "> Mute Audio", callback_data='TiiGeRTeaM'}, 
...
_》Age :_ *18*
_》Name :_ *Arashwm Mohseni*
_》City :_ *Dorod - Borojerd*
*-------------------------*
*》GitHub :《*
》[Arashwm](Github.Com/MahDiRoO)
*-------------------------*
*》Bridges :《*
_》Pv : _[Arashwm](Telegram.Me/Arashwm)
_》PvResan : _[Arashwm PvResan](Telegram.Me/Arashssdbot)
*-------------------------*
*》Expertise :《*
...
local text = [[*》Xamarin_Developer Information《*
			...
			*-------------------------*
			*》Bridges《*
			》Pv : [@Panizazariii](Telegram.Me/Panizazariii)
			》PvResan : [@Arashssdbot](Telegram.Me/Arashssdbot)
			*-------------------------*
			*》Expertise《*
			》*C#* and a bit *C++*
			*-------------------------*]]
